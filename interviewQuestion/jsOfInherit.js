...
*/
/*
2.类式继承，继承方式是通过对子类的prototype.__proto__引用父类的prototype，
...
我们只会调用一次父类的构造函数。所以只能在子类中重写父类的属性，如上的name属性，
在子类中需要重写一次。
*/
/* (function () {
  function Father () {
...
// 3.构造函数call()方法+类式继承
// 优点：既可以访问父类中的公开方法和属性(prototype中的方法)
// 又可以避免引用陷阱-子类对象可以随意修改父类中的方法和变量，并影响其他子类对象
// 缺点：调用了两次父类的构造函数
/* (function () {
  function Father () {
    this.name = '严正强'
 ...
 */
// 4.如何避免调用两次父类的构造函数？使用Object.creat
(function () {
  function Father () {
    this.name = '严正强'
    this.age = '55'
  ...
  // Child.prototype = new Father() // 使用Object.creat替代
  Child.prototype.constructor = Child // 构造函数指回Child
  var child = new Child()
  console.log('child', child)
  // child.type.push(100)
  // var child1 = new Child()
...
// 5.如何避免调用两次父类的构造函数？使用Object.creat
/* (function () {
  function Father () {
    this.name = '严正强'
    this.age = '55'
